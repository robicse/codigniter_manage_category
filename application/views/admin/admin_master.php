			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>administrator/add_category"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Category</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>administrator/manage_category"><i class="icon-edit"></i><span class="hidden-tablet"> Manage Category</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>administrator/add_blog"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add Blog</span></a></li>
